...
@blueprint.route('/registro_shop', methods=['GET', 'POST'])
@login_required
def registro_shop():
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("home_blueprint.registro_shop"))
    ...
    # Base query
    registro_query = Registro.query.filter_by(servici="Shop")
    ...
    return render_template('home/registro_shop.html', 
                           segment='registro', 
...
# NEW: Customer view & add route
@blueprint.route('/registro_onsite', methods=['GET', 'POST'])
@login_required
def registro_onsite():
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("home_blueprint.registro_onsite"))
    ...
    # Base query
    registro_query = Registro.query.filter_by(servici="On-site")
    ...
    return render_template('home/registro_onsite.html', 
                           segment='registro', 
                           #registro_data=registro_data,
                           registro_table=registro_table,
                           makes=makes,
...
@blueprint.route('/registro_shop/edit/<int:jo_id>', methods=['GET', 'POST'])
@login_required
def edit_registro_shop(jo_id):
    ...
    return render_template(
        "home/registro_shop.html",
        segment="registro",
        registro=registro,
        makes=makes
    )
    
@blueprint.route('/registro_onsite/edit/<int:jo_id>', methods=['GET', 'POST'])
@login_required
def edit_registro_onsite(jo_id):
    registro = Registro.query.get_or_404(jo_id)
...
@login_required
def delete_registro_shop(jo_id):
    registro = Registro.query.get_or_404(jo_id)
...
@blueprint.route('/registro/delete/<int:jo_id>', methods=['POST'])
@login_required
def delete_registro_onsite(jo_id):
    registro = Registro.query.get_or_404(jo_id)
